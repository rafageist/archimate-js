...
export default function ArchimateRenderer(
  ...
  function renderArchimateShape(parentGfx, shape) {
    ...
    var elementType = shape.type,
      ...
      borderRadius = BORDER_ASPECT_MAP.get(shape.aspect) || 0;
    ...
    var registryNotation = Archimate4Registry.resolveNotation(elementType);
    var pictoRef = registryNotation && registryNotation.rendererAvailable
      ? registryNotation.rendererRef
      : getPictoRef(elementType);
  ...
  this.handlers = {
    ...
    'Association': function(parentGfx, connection) {
      ...
      if (connection.typeOption === 'directed' || connection.typeOption === true) {
