...
import {
  ARCHIMATE4_ELEMENT_MAP,
  NOTE
} from '../../util/ModelUtil';

export function getArchimate4PaletteDefinitions() {
  return new Map(
    [ ...ARCHIMATE4_ELEMENT_MAP ].filter(([, definition]) => definition.notation.status === 'complete')
  );
}
...
*/
  ...
  function addElementMap(elementMap) {
  ...
  addElementMap(getArchimate4PaletteDefinitions());
