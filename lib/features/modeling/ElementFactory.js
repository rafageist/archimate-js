...
import { normalizeAccessMode, normalizeAssociationMode } from '../../archimate4/RelationshipRules';
...
function setAttrsRelationshipRef(attrs, relationshipRef) {
  ...
  if (attrs.type === 'Access') {
    assign(attrs, {
      typeOption: normalizeAccessMode(relationshipRef && relationshipRef.accessType)
    });
  }

  if (attrs.type === 'Association') {
    assign(attrs, {
      typeOption: normalizeAssociationMode(relationshipRef && relationshipRef.isDirected)
    });
  }
